...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/IsrealOfficialTech/MASKY_BOT_MD__V1';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/o4q2wl.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '0029VbBeOQt7j6g5YFBmKR1o@newsletter',
                    newsletterName: config.OWNER_NAME || 'MASKYBOT-MD',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
        ...
        // Send audio
        await conn.sendMessage(from, {
            audio: { url: 'https://files.catbox.moe/k30ftp.mp4' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
